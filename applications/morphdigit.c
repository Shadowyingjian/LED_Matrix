...
static const uint8_t sA = 0;
static const uint8_t sB = 1;
static const uint8_t sC = 2;
static const uint8_t sD = 3;
static const uint8_t sE = 4;
static const uint8_t sF = 5;
static const uint8_t sG = 6;
static const int segHeight = 5;
static const int segWidth = segHeight;
static uint8_t xOffset,yOffset;

static ColorDef m_color;
static rt_bool_t b_morph_reinit = 0;

static void draw_pixel_offset(uint8_t x, uint8_t y, ColorDef c)
{
    draw_pixel(xOffset + x, yOffset + y, c);
}

static void draw_line_offset(uint8_t x, uint8_t y,uint8_t deltax, uint8_t deltay, ColorDef c)
{
    draw_line(xOffset + x, yOffset + y, deltax, deltay, c);
}

//无offset
static void draw_seg(uint8_t seg)
{
    switch(seg)
    {
        case sA:
...
static void draw_num(uint8_t x, uint8_t y,uint8_t num)
{
    xOffset = x;
    yOffset = y;
    switch(num)
...
static void morph(uint8_t x,uint8_t y,uint8_t newValue) {
    xOffset = x;
    yOffset = y;
    switch (newValue) {
        case 0:
